...
$packageName    = 'Winrad'       # arbitrary name for the package, used in messages
$installerType  = 'MSI'       # only one of these: exe, msi, msu

$url            = 'http://www.winrad.org/bin/Winrad161.msi'          # download url
$silentArgs     = '/quiet /passive /qn'      # "/s /S /q /Q /quiet /silent /SILENT /VERYSILENT" # try any of these to get the silent installer #msi is always /quiet
